...
alias update='sudo pacman -Syyu && paru -Syua --skipreview; sudo pacman -Rsn $(paru -Qdtq); paru -cc'
...
alias armorpaint='cd armorpaint/armorcore/Deployment; ./ArmorPaint ../../build/krom; cd'
