...
let g:update_focused_file = 1 "0 by default, this option allows the cursor to be updated when entering a buffer
let g:nvim_tree_indent_markers = 1 "0 by default, this option shows indent markers when folders are open
let g:nvim_tree_git_hl = 1 "0 by default, will enable file highlight for git attributes (can be used without the icons).
let g:nvim_tree_highlight_opened_files = 1 "0 by default, will enable folder and file icon highlight for opened files/directories.
let g:nvim_tree_root_folder_modifier = ':~' "This is the default. See :help filename-modifiers for more options
let g:tab_open = 1 "0 by default, will open the tree when entering a new tab and the tree was previously open
...
hi NvimTreeEmptyFolderName guifg=#555657
hi NvimTreeExecFile guifg=#ff8278
hi NvimTreeFolderIcon guifg=#77bee0
hi NvimTreeFolderName guifg=#77bee0
hi NvimTreeImageFile guifg=#dd91f3
hi NvimTreeOpenedFolderName guifg=#dddddd
hi NvimTreeRootFolder guifg=#f5d1c8
