...
(autothemer-deftheme
 ...
 (
  ...
  (org-level-1 (:foreground purple :font "sans" :weight 'bold :height 1.75))
  (org-level-2 (:foreground blue :font "sans" :weight 'bold :height 1.50))
  (org-level-3 (:foreground green :font "sans" :weight 'bold :height 1.25))
  (org-level-4 (:foreground yellow :font "sans" :weight 'bold :height 1.1))
  (org-level-5 (:foreground orange :font "sans" :weight 'bold))
